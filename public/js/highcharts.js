...
;(function (S, M) {
    ...
    M(J, 'parts/Utilities.js', [J['parts/Globals.js']], function (c) {
        ...
        c.formatSingle = function (d, a, b) {
            ...
            ;/f$/.test(d)
                ? ((h = (h = d.match(h)) ? h[1] : -1),
                  null !== a &&
                      (a = b(a, h, f.decimalPoint, -1 < d.indexOf(',') ? f.thousandsSep : '')))
                : (a = k.dateFormat(d, a))
            return a
        }
    ...
    M(J, 'parts/SvgRenderer.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
        ...
        q(P.prototype, {
                ...
                c.fireEvent(this.renderer, 'complexColor', { args: arguments }, function () {
                    ...
                    Q &&
                        ...
                        'radialGradient' === Q &&
                            ...
                            !G(g.gradientUnits) &&
                            ((z = g),
                            (g = L(g, n.getRadialAttr(x, z), { gradientUnits: 'userSpaceOnUse' }))),
                        m(g, function (a, b) {
                            'id' !== b && N.push(b, a)
                        }),
                        m(t, function (a) {
            ...
            setTextPath: function (a, b) {
                ...
                if (a && b && b.enabled) {
                    ...
                    z ||
                        ((this.textPathWrapper = z = this.renderer.createElement('textPath')),
                        (g = !0))
                    var t = z.element
        ...
        q(e.prototype, {
            ...
            buildText: function (a) {
                ...
                var V = function (a) {
                    ...
                    P = function (a, b) {
                        ...
                        if (
                            -1 !== d &&
                            ((d = d + b.length + 1), (b = a.charAt(d)), '"' === b || "'" === b)
                        )
                          ...
                          z
                              ? ((g = d.styledMode
                                    ? g
                                          .replace(
                                              /<(b|strong)>/g,
                                              '<span className="highcharts-strong">'
                                          )
                                          .replace(
                                              /<(i|em)>/g,
                                              '<span className="highcharts-emphasized">'
                                          )
                                    : g
                                          .replace(
                                              /<(b|strong)>/g,
            ...
            rect: function (a, b, d, n, g, z) {
                ...
                this.styledMode ||
                    ('undefined' !== typeof z && ((a.strokeWidth = z), (a = f.crisp(a))),
                    (a.fill = 'none'))
                g && (a.r = g)
    ...
    M(J, 'parts/Html.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
        ...
        G(e.prototype, {
            ...
            html: function (c, r, f) {
                ...
                d.styledMode ||
                    b.css({ fontFamily: this.style.fontFamily, fontSize: this.style.fontSize })
        ...
        c.Time.prototype = {
            ...
            getTimeTicks: function (c, r, e, A) {
                ...
                if (F(r)) {
                    ...
                    h >= u.hour &&
                        f.set('Hours', d, h >= u.day ? 0 : k * Math.floor(f.get('Hours', d) / k))
                    h >= u.day &&
                        f.set(
                            'Date',
                            d,
                            h >= u.month ? 1 : Math.max(1, k * Math.floor(f.get('Date', d) / k))
                        )
                    if (h >= u.month) {
            ...
            getMinorTickPositions: function () {
                ...
                if (t && t / g < a.len / 3)
                    if (a.isLog)
                        ...
                        f = f.concat(
                            a.getTimeTicks(a.normalizeTimeTickInterval(g), c, h, b.startOfWeek)
                        )
                    ...
                    (q(a.min) || q(a.max)
                        ...
                        : (this.series.forEach(function (a) {
                              ...
                              for (f = t = a.xIncrement ? 1 : c.length - 1; 0 < f; f--)
                                  if (((h = c[f] - c[f - 1]), 'undefined' === typeof g || h < g))
                                      g = h
                          }),
            ...
            drawCrosshair: function (a, b) {
                ...
                if (this.crosshair && !1 !== (q(b) || !f)) {
                    f
                        ...
                        : (h =
                              a &&
                              (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos))
                    if (q(h)) {
                        var t = {
    ...
    M(J, 'parts/Tooltip.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
        ...
        c.Tooltip.prototype = {
                ...
                e = e.slice(0, f.length + 1).reduce(function (d, c, h) {
                    if (!1 !== c && '' !== c) {
                        ...
                        l ||
                            ...
                            u ||
                                ((l.fill = w.backgroundColor), (l['stroke-width'] = w.borderWidth)),
                            (l = L.label(
                                null,
                                null,
                                null,
                                ...
                                .addClass(
                                    x ? 'highcharts-tooltip-header ' : 'highcharts-tooltip-box ' + k
                                )
                                .attr(l)
                                .add(R)))
                        l.isActive = !0
            ...
            styledModeFormat: function (c) {
                return c
                    .replace('style="font-size: 10px"', 'className="highcharts-header"')
                    .replace(
                        /style="color:{(point|series)\.color}"/g,
                        'className="highcharts-color-{$1.colorIndex}"'
                    )
            }
        }
    })
            ...
            scaleGroups: function (a, b) {
                ...
                d.series.forEach(function (f) {
                    ...
                    f.xAxis &&
                        ...
                        (f.group.attr(c),
                        f.markerGroup &&
                            (f.markerGroup.attr(c), f.markerGroup.clip(b ? d.clipRect : null)),
                    ...
                    if (
                        ...
                        b.hasCartesianSeries &&
                            ...
                            b.styledMode ||
                                E.attr({
                                    fill:
                                        c.selectionMarkerFill || r('#335cad').setOpacity(0.25).get()
                                }))
                        E && m && ((f -= n), E.attr({ width: Math.abs(f), x: (0 < f ? 0 : f) + n }))
                        E &&
                            p &&
                            ((f = e - z), E.attr({ height: Math.abs(f), y: (0 < f ? 0 : f) + z }))
            ...
            F(c.Pointer.prototype, {
                ...
                pinch: function (c) {
                    var e = this,
                        ...
                        f =
                            1 === w &&
                            ((e.inClass(c.target, 'highcharts-tracker') && v.runTrackerClick) ||
                                e.runChartClick),
                        b = {}
                    1 < w && (e.initiated = !0)
                ...
                touch: function (e, q) {
                    ...
                    if (1 === e.touches.length)
                        if (
                            ((e = this.normalize(e)),
                            (B = v.isInsidePlot(e.chartX - v.plotLeft, e.chartY - v.plotTop)) &&
                                !v.openMenu)
                        ) {
        ...
        c.Legend.prototype = {
            ...
            colorizeItem: function (b, a) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    f && f.attr({ stroke: p })
                    e &&
                        (g && e.isMarker && ((t = b.pointAttribs()), a || (t.stroke = t.fill = m)),
                        e.attr(t))
                }
                    ...
                    this.allItems.forEach(function (f) {
                        ...
                        if (e) {
                            ...
                            u(e, {
                                ...
                                top: h + 'px',
                                display:
                                    this.proximate || (h > c - 6 && h < c + a - 6) ? '' : 'none'
                            })
                        }
                    }, this)
                }
            ...
            applyDescription: function (a, b) {
                ...
                g &&
                    ...
                    ((c = this.renderer
                        ...
                        .add()),
                    (c.update = function (b) {
                        d[{ title: 'setTitle', subtitle: 'setSubtitle', caption: 'setCaption' }[a]](
                            b
                        )
                    }),
                    ...
                    for (m = 0; m < p; m++) {
                        ...
                        var M = F.low,
                            Z =
                                b &&
                                e.stacks[
                                    (this.negStacks && W < (B ? 0 : A) ? '-' : '') + this.stackKey
                                ]
                        e.positiveValuesOnly && null !== W && 0 >= W && (F.isNull = !0)
                        F.plotX = C = v(
                            H(d.translate(J, 0, 0, 0, 1, r, 'flags' === this.type), -1e5, 1e5)
                        )
                        ...
                        F.plotY = W =
                            'number' === typeof W && Infinity !== W
                                ...
                                : void 0
                        F.isInside =
                            'undefined' !== typeof W && 0 <= W && W <= e.len && 0 <= C && C <= d.len
                ...
                },
                {
                    ...
                    pointAttribs: function (c, e) {
                        ...
                        e &&
                            ...
                            (a =
                                c.color ||
                                ('undefined' !== typeof e && C(a).brighten(c.brightness).get()) ||
                                a),
                            (d = c[f] || d),
                            (h = c[b] || h),
                            (r = c.dashStyle || r),
                        ...
                        if (!f.isNull && e) {
                            ...
                            f.delayedRendering
                                ? (e.setRadialReference(c.center).attr(l).attr(d),
                                  b.styledMode ||
                                      e.attr(k).attr({ 'stroke-linejoin': 'round' }).shadow(m, h),
    ...
    M(J, 'parts/DataLabels.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
        ...
        D.prototype.alignDataLabel = function (b, a, c, e, f) {
            ...
            if (A) {
                    ...
                    ? ((w = !1),
                      ...
                      (k = {
                          ...
                          y:
                              e.y +
                              c.y +
                              { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * e.height
                      }),
                      C(k),
                ...
                w && 0 <= e.height
                    ...
                    : B(c.crop, !0) &&
                      (A =
                          h.isInsidePlot(k.x, k.y) && h.isInsidePlot(k.x + q.width, k.y + q.height))
                if (c.shape && !r)
                    a[f ? 'attr' : 'animate']({
        ...
        D.prototype.justifyDataLabel = function (b, a, c, e, f, l) {
            ...
            m = c.x + e.width - k
            m > d.plotWidth &&
                ('left' === h ? ((a.align = 'right'), (a.inside = !0)) : (a.x = d.plotWidth - m),
                (q = !0))
            m = c.y + k
            0 > m &&
                ('bottom' === g ? ((a.verticalAlign = 'top'), (a.inside = !0)) : (a.y = -m),
                (q = !0))
            m = c.y + e.height - k
            m > d.plotHeight &&
                ('top' === g
    ...
    M(
        ...
        function (c, e) {
            ...
            e.prototype.hideOverlappingLabels = function (c) {
                ...
                for (m = 0; m < q; m++)
                    if ((w = c[m]))
                        (w.oldOpacity = w.opacity), (w.newOpacity = 1), (w.absoluteBox = A(w))
                c.sort(function (a, b) {
                    ...
                    b ||
                        e.getSelectedPoints().forEach(function (a) {
                            ...
                            a.selected &&
                                ...
                                a.setState(
                                    e.hoverPoints && b.options.inactiveOtherPoints ? 'inactive' : ''
                                ),
                    ...
                    a && a.size && u && 'hidden' !== e && !this.isCluster
                        ? (w || (c.halo = w = y.renderer.path().add(u.parentGroup)),
                          ...
                          y.styledMode ||
                              w.attr(
                                  I(
                                      { fill: this.color || c.color, 'fill-opacity': a.opacity },
                                      a.attributes
                                  )
                              ))
                        : w &&
        ...
        I(a.prototype, {
            ...
            setState: function (a, b) {
                ...
                if (
                    ...
                    f ||
                        [c.group, c.markerGroup, c.dataLabelsGroup, c.labelBySeries].forEach(
                            function (a) {
