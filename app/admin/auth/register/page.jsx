                                        ...
                                        <form className="mt-4 form-text">
                                            ...
                                            <div className="d-inline-block w-100">
                                                <div className="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                                    ...
                                                    <label className="custom-control-label" for="customCheck1">I accept <Link href="#" className="text-light">Terms and Conditions</Link></label>
                                                </div>
                                            </div>
                                            <div className="sign-info text-center">
                                                <button type="submit" className="btn btn-white d-block w-100 mb-2">Sign Up</button>
                                                <span className="text-dark d-inline-block line-height-2">Already Have Account ? <Link href="/admin/auth/login" className="text-white">Log In</Link></span>
                                            </div>
                                        </form>
                                    </div>
                                </div>
