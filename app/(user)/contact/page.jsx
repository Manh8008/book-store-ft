                    ...
                    <div className="container">
                        <div className="contact-info">
                            ...
                            <p>
                                ...
                                cầu sử dụng dịch vụ của quý khách, chúng tôi mong muốn nhận được các thông
                                tin phản hồi. Nếu quý khách có bất kỳ thắc mắc hoặc góp ý nào, vui lòng liên
                                hệ với chúng tôi theo thông tin dưới đây. Chúng tôi sẽ phản hồi quý khách
                            ...
                            <ul>
                                ...
                                <li>Công viên phần mềm Quang Trung, Quận 12 thành phố Hồ Chí Minh</li>
                            </ul>
                        </div>
                        <div className="contact-form">
                            ...
                            <form>
                                ...
                                <Button primary type="submit">Gửi liên hệ</Button>
                            </form>
                        </div>
                    </div>
                </div>
